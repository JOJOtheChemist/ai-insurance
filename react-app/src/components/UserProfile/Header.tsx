            ...
            <div className="flex items-center gap-4">
                <div className="relative">
                    <div className="w-20 h-20 rounded-full border-4 border-white shadow-sm overflow-hidden bg-gray-200">
                        <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=SalesUser" className="w-full h-full" alt="Avatar" />
                    </div>
                    <div
                ...
                <div>
                    <h1 className="text-2xl font-black text-gray-900 leading-tight">王牌销售</h1>
                    <div className="flex items-center gap-2 mt-1.5">
                        <span className="text-sm text-gray-500 font-medium">ID: 890211</span>
                        <span
