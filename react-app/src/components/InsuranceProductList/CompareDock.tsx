...
const CompareDock: React.FC<CompareDockProps> = ({ selectedCount, active }) => {
    return (
        <div
        ...
        >
            ...
            <div className="flex gap-2">
                <button className="bg-blue-600 hover:bg-blue-500 text-white px-4 py-2 rounded-full text-xs font-bold flex items-center gap-1.5 transition-colors shadow-lg shadow-blue-900/50">
