...
\`\`\`json
{
  "thought": "确认已获取背景并描述下一步策略。如果调用了 get_client_profile 且成功，请在此确认。",
  "customer_profile": {
    "name": "待确认",
    "role": "待确认",
    "age": "待确认",
  ...
  "insight_summary": "3 句以内总结客户痛点与策略建议。",
  "recommendations": [
    {
      "product_id": "具体 ID",
      "product_name": "名称",
  ...
  "next_actions": [
    "对比分析：将该方案与友邦/平安同类产品进行深度横评",
    "生成话术：针对该客户的保障缺口，生成一段极具说服力的推销话术",
    "异议处理：如果客户觉得保费太贵，我该如何从资产穿透角度进行解释？"
  ]
}
\`\`\`
<text_guidance>
以上 JSON 中的 \`next_actions\` 承担着「剧情发展引导」的作用，你必须根据当前的对话进展，给出 2-4 个引导代理人继续互动的“快捷选项”。
</text_guidance>
</output_format>
