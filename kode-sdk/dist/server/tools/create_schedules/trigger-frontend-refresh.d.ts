 ...
 * @returns 刷新指令字符串
 */
export declare function createRefreshInstruction(dates: string[]): string;
/**
 * 从消息中提取刷新指令
 *
 ...
 */
export declare function extractRefreshInstruction(message: string): string[];
/**
 * 移除消息中的刷新指令（用于显示给用户）
 *
 * @param message - AI响应消息
 * @returns 移除刷新指令后的消息
 */
export declare function removeRefreshInstruction(message: string): string;
/**
 * 使用示例：
 *
 * // 在工具返回时添加刷新指令
